...
def add_dataframe_to_graph(graph_file, dataframe_file, graph_column, dataframe_column):
    # Read the graph file
...
if __name__ == '__main__':
    ...
    add_dataframe_to_graph(args.graph, args.dataframe, args.graph_name, args.dataframe_column)